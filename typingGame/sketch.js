...
if (gameScore.loss === 3 || gameScore.total === 10) { gameOver = true;                                     displayGameOver(gameScore);
return;
}
...
this.drawEllipse(35, 3, 1.2, .75 * this.content * 3000);
pop();
push();
...
// decrease the alpha value by the decrement value with each renderthis.alpha = this.alpha - this.alphaDecrement;
pop();
  }
